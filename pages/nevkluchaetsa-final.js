          ...
          <div className="page-container13">
            ...
            <div className="vicetext">
              ...
              <p>
                ...
                Если машинка всё ещё не подаёт признаков жизни, ссмотрите сетевой фильтр и впускной клапан. Для фильтра нужен мультиметр, для клапана — визуальный осмотр или звон мастеру. Часто эти детали меняют полностью.
              </p>
            </div>
          </div>
        </section>
