...
const Page = () => {
  ...
  const sections = [
    ...
    { id: '3', title: '7. Как самостоятельно слить воду?', image: '/1/bludechko.webp', imageAlt: 'блюдечко', imageCaption: 'Подготовка к аварийному сливу', content: `<p><strong>1.</strong> <span class="step-lead">Отключите питание.</span> Выньте вилку из розетки — это обязательная мера безопасности. <br/><strong>2.</strong> <span class="step-lead">Подготовьте тряпки и низкую ёмкость.</span> Возьмите тряпки или старые полотенца и плоскую невысокую ёмкость (таз, миску или лоток). Если можно — отведите сливной шланг в душевую/ванну; иначе собирайте воду в ёмкость и переносите.<br/><strong>3.</strong> <span class="step-lead">Дайте воде остыть.</span> Если стирка была недавно, дождитесь остывания. Оцените температуру по стеклу люка: если оно горячее — подождите. <br/><strong>4.</strong> <span class="step-lead">Откройте доступ к фильтру.</span> Он внизу спереди за крышкой. Подставьте плоскую ёмкость и аккуратно приоткрутите пробку для слива. <br/><strong>5.</strong> <span class="step-lead">Наклоните машинку назад.</span> Так остатки быстрее стекают к фильтру. Делайте это вдвоём — техника тяжёлая. <br/><strong>6.</strong> <span class="step-leад">Очистите фильтр и установите обратно.</span> Когда вода выйдет, выкрутите фильтр до конца, удалите мусор, промойте и установите обратно.</p>` },
    { id: '4', title: '8. Советы по профилактике', image: null, imageAlt: '', imageCaption: '', content: `<p><strong>1.</strong> <span class="step-lead">Регулярно очищайте фильтр.</span> Чистый фильтр предотвращает заторы из ворса и мелкого мусора. <br/><strong>2.</strong> <span class="step-lead">Проверяйте карманы и не допускайте мелкие предметы.</span> Проверяйте карманы одежды перед стиркой: монеты, заколки, платки и т.п. могут попасть в патрубок. <br/><strong>3.</strong> <span class="step-lead">Следите, чтобы шланг не перегибался, и ставьте машинку ровно.</span> Шланг не должен перегибаться или пережиматься. Оптимальная высота вывода — до 50 см от уровня пола. Ставьте машинку ровно и снижайте вибрации, чтобы не перетирались провода и не ослабевали патрубки. <br/><strong>4.</strong> <span class="step-lead">Следите за канализацией и сифоном.</span> Убедитесь, что стояк или сифон не засорены. Если из раковины вода уходит медленно, стирочная может застаиваться. Периодически очищайте сантехнику.</p>` },
  ]
